# This dockerfile uses extends image https://hub.docker.com/sinlov/git-extra-diff-excel
# VERSION 1
# Author: sinlov
...
ARG GO_ENV_PACKAGE_NAME=github.com/sinlov/git-extra-diff-excel
ARG GO_ENV_ROOT_BUILD_BIN_NAME=git-extra-diff-excel
ARG GO_ENV_ROOT_BUILD_BIN_PATH=build/${GO_ENV_ROOT_BUILD_BIN_NAME}
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/git-extra-diff-excel/main.go
...
ENTRYPOINT [ "/app/git-extra-diff-excel" ]
# CMD ["/app/git-extra-diff-excel", "--help"]
	...
	jsonInfo = `
{
  ...
  "author": {
    ...
    "url": "https://github.com/sinlov/git-extra-diff-excel"
  }
}
`
	jsonInfoGoStyle = `
{
  ...
  "homepage": "https://github.com/sinlov/git-extra-diff-excel#readme"
}
`
)
...
func TestGetPackageJsonHomepage(t *testing.T) {
	...
	InitPkgJsonContent(jsonInfoGoStyle)
	assert.Equal(t, "https://github.com/sinlov/git-extra-diff-excel#readme", GetPackageJsonHomepage())
}
